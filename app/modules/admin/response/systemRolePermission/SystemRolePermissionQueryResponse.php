...
namespace app\modules\admin\response\systemRolePermission;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SystemRolePermissionQueryResponse')]
class SystemRolePermissionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemRolePermissionResponse::class))]
    private array $data;
