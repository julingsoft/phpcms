...
namespace app\modules\admin\response\systemRoleMenu;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SystemRoleMenuQueryResponse')]
class SystemRoleMenuQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemRoleMenuResponse::class))]
    private array $data;
