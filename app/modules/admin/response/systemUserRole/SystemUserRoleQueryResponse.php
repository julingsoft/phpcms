...
#[OA\Schema(schema: 'SystemUserRoleQueryResponse')]
class SystemUserRoleQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemUserRoleResponse::class))]
    private array $data;
