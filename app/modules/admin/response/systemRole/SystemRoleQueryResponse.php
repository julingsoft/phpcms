...
namespace app\modules\admin\response\systemRole;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SystemRoleQueryResponse')]
class SystemRoleQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemRoleResponse::class))]
    private array $data;
