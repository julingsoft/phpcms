...
namespace app\modules\admin\response\systemMenu;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SystemMenuQueryResponse')]
class SystemMenuQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemMenuResponse::class))]
    private array $data;
