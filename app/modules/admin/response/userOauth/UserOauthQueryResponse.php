...
namespace app\modules\admin\response\userOauth;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'UserOauthQueryResponse')]
class UserOauthQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserOauthResponse::class))]
    private array $data;
