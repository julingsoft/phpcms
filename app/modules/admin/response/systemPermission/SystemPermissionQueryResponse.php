...
namespace app\modules\admin\response\systemPermission;

use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SystemPermissionQueryResponse')]
class SystemPermissionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemPermissionResponse::class))]
    private array $data;
