...
namespace app\modules\admin\request\systemRolePermission;

use OpenApi\Attributes as OA;
use think\Validate;

#[OA\Schema(
    schema: 'SystemRolePermissionUpdateRequest',
    required: [
        'id',
        'create_time',
        'update_time',
...
class SystemRolePermissionUpdateRequest extends Validate
{
    protected $rule = [
        'id' => 'require',
        'create_time' => 'require',
