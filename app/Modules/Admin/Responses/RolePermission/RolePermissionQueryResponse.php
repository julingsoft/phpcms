...
#[OA\Schema(schema: 'RolePermissionQueryResponse')]
class RolePermissionQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RolePermissionResponse::class))]
    private array $data;
