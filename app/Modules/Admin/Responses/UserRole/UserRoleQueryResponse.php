...
#[OA\Schema(schema: 'UserRoleQueryResponse')]
class UserRoleQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserRoleResponse::class))]
    private array $data;
