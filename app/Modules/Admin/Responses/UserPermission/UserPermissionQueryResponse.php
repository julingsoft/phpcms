...
#[OA\Schema(schema: 'UserPermissionQueryResponse')]
class UserPermissionQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: UserPermissionResponse::class))]
    private array $data;
