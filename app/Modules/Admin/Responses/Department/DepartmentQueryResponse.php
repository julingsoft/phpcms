...
#[OA\Schema(schema: 'DepartmentQueryResponse')]
class DepartmentQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: DepartmentResponse::class))]
    private array $data;
