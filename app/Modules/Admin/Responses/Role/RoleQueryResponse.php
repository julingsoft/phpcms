...
#[OA\Schema(schema: 'RoleQueryResponse')]
class RoleQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RoleResponse::class))]
    private array $data;
