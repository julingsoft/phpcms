...
#[OA\Schema(schema: 'TenantUserQueryResponse')]
class TenantUserQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: TenantUserResponse::class))]
    private array $data;
